...
class DataTransformation: 
    ...
    def get_data_transformation_object(self): 
        try: 
            ...
            numerical_cols = ['Lifeexpectancy', 'AdultMortality',  'infantdeaths',  'Alcohol',  'percentageexpenditure',  'Measles',  'BMI',  'under-fivedeaths',  'Polio',  'Totalexpenditure',  'Diphtheria', 'HIV/AIDS',  'GDP',  'Population',  'thinness1-19years',  'thinness5-9years',  'Incomecompositionofresources',
 'Schooling']
            
            # Define the custom ranking for each ordinal variable
            Status_categories = ['Developing', 'Developed']           
            ...
            cat_pipeline=Pipeline(
                ...
                ('ordinalencoder',OrdinalEncoder(categories=[Status_categories])),
                ('scaler',StandardScaler())
                ]
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try: 
            ...
            target_colum_name = 'Lifeexpectancy'
            ...
            print(input_feature_test_df.head(4))
